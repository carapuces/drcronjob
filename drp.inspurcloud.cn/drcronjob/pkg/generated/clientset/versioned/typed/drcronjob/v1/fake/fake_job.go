...
import (
	v1 "drp.inspurcloud.cn/drcronjob/pkg/apis/drcronjob/v1"
	drcronjobv1 "drp.inspurcloud.cn/drcronjob/pkg/generated/clientset/versioned/typed/drcronjob/v1"
...
func newFakeJobs(fake *FakeBatchV1, namespace string) drcronjobv1.JobInterface {
	return &fakeJobs{
