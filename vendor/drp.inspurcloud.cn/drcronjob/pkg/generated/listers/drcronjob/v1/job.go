...
type JobLister interface {
	...
	List(selector labels.Selector) (ret []*drcronjobv1.Job, err error)
...
type jobLister struct {
	listers.ResourceIndexer[*drcronjobv1.Job]
}

// NewJobLister returns a new JobLister.
func NewJobLister(indexer cache.Indexer) JobLister {
	return &jobLister{listers.New[*drcronjobv1.Job](indexer, drcronjobv1.Resource("job"))}
}

// Jobs returns an object that can list and get Jobs.
func (s *jobLister) Jobs(namespace string) JobNamespaceLister {
	return jobNamespaceLister{listers.NewNamespaced[*drcronjobv1.Job](s.ResourceIndexer, namespace)}
}
...
type JobNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*drcronjobv1.Job, error)
