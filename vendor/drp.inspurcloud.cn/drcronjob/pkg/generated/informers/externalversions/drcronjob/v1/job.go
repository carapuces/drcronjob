...
import (
	...
	apisdrcronjobv1 "drp.inspurcloud.cn/drcronjob/pkg/apis/drcronjob/v1"
	versioned "drp.inspurcloud.cn/drcronjob/pkg/generated/clientset/versioned"
	internalinterfaces "drp.inspurcloud.cn/drcronjob/pkg/generated/informers/externalversions/internalinterfaces"
	drcronjobv1 "drp.inspurcloud.cn/drcronjob/pkg/generated/listers/drcronjob/v1"
...
func (f *jobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisdrcronjobv1.Job{}, f.defaultInformer)
}

func (f *jobInformer) Lister() drcronjobv1.JobLister {
	return drcronjobv1.NewJobLister(f.Informer().GetIndexer())
}
