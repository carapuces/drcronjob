...
import (
	...
	drcronjobv1 "drp.inspurcloud.cn/drcronjob/pkg/apis/drcronjob/v1"
	clientset "drp.inspurcloud.cn/drcronjob/pkg/generated/clientset/versioned"
	samplescheme "drp.inspurcloud.cn/drcronjob/pkg/generated/clientset/versioned/scheme"
	informers "drp.inspurcloud.cn/drcronjob/pkg/generated/informers/externalversions/drcronjob/v1"
	listers "drp.inspurcloud.cn/drcronjob/pkg/generated/listers/drcronjob/v1"
)
...
type Controller struct {
	...
	foosLister        listers.DRCronJobLister
...
func NewController(
	...
	fooInformer informers.DRCronJobInformer) *Controller {
...
func (c *Controller) syncHandler(ctx context.Context, objectRef cache.ObjectName) error {
	...
	foo, err := c.foosLister.DRCronJobs(objectRef.Namespace).Get(objectRef.Name)
	if err != nil {
	...
	deploymentName := foo.Spec.JobTemplate.Name
	if deploymentName == "" {
...
func (c *Controller) updateFooStatus(ctx context.Context, foo *drcronjobv1.DRCronJob, deployment *appsv1.Deployment) error {
...
func (c *Controller) handleObject(obj interface{}) {
	...
	if ownerRef := metav1.GetControllerOf(object); ownerRef != nil {
		...
		foo, err := c.foosLister.DRCronJobs(object.GetNamespace()).Get(ownerRef.Name)
		if err != nil {
